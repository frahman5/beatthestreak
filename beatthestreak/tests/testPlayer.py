...
class testPlayer(unittest.TestCase):
    ...
    def test_get_and_set_retrosheet_id_and_init(self):
        ...
        self.assertRaises(NoPlayerException, Player, "oogly", "boogly", 1999)
    ...
    def test_eq__(self):
        ...
        p1 = Player("Jose", "Reyes", 2012, debut='6/10/2003')
        p2 = Player("Jose", "Reyes", 2010, debut='6/10/2003')
        self.assertEqual(p1, p2)
        # test that a player-from-name and player-from-playerL are equiv
        p3 = Player("reyesjo01", 2010)
